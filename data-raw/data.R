...
columns2 <- c("childID", "sex", "card", "know_dob", "dob", "age_report", "age",
              "age_check", "muac1", "muac_screen", "oedema1", "oedema_screen",
              "oedema_check", "muac", "sam", "muac2", "oedema2",
              "oedema_check2", "muac1a", "sam1a", "muac3", "oedema3",
              "oedema_check3", "muac1b", "sam1b", "nut_status", "cov_status",
...
coverageData.r2 <- coverageData[ , c("motherID", "sdate", "cid", "county", "did",
                                     "eid", "consent2", "m2", "ch", "mcheck1",
                                     "ifa1", "ifa2", "ifa3", "ifa3a.1", "ifa3a.2",
                                     "ifa3a.3", "ifa3a.88", "ifa3a_other", "ifa4",
                                     "ifa4a.1", "ifa4a.2", "ifa4a.3", "ifa4a.4",
                                     "ifa4a.88", "ifa4a_other","ifa5", "icf1",
                                     "icf2", "icf2a.1", "icf2a.2", "icf2a.3",
                                     "icf2a.4", "icf2a.88", "icf2a_other", "icf3",
                                     "c2", "cage", "csex", "mnp1", "mnp2",
                                     "mnp2a.1", "mnp2a.2", "mnp2a.3", "mnp2a.4",
                                     "mnp2a.5", "mnp2a.88", "mnp2a_other", "mnp3",
                                     "mnp3a.1", "mnp3a.2", "mnp3a.3", "mnp3a.4",
                                     "mnp3a.5", "mnp3a.6", "mnp3a.7", "mnp3a.8",
                                     "mnp3a.9", "mnp3a.88", "mnp3a_other", "mnp4",
                                     "vit1", "vit1a.1", "vit1a.2", "vit1a.3",
                                     "vit1a.4", "vit1a.88", "vit1a_other", "vit2",
                                     "vit3",
                                     "childID", "sex", "card", "know_dob", "dob",
